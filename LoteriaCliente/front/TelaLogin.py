...
class Ui_TelaLogin(object):
    def setupUi(self, TelaLogin):
        ...
        self.label.setGeometry(QtCore.QRect(550, 40, 191, 191))
        ...
        self.lineEditSenha.setGeometry(QtCore.QRect(140, 130, 281, 27))
        ...
        self.pushButtonLogar.setGeometry(QtCore.QRect(70, 210, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButtonSairLogin.setGeometry(QtCore.QRect(340, 210, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
